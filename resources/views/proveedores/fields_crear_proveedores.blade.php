        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('id_tipo_persona', collect(['' => 'Seleccionar...'])->union($tipos_proveedor), old('id_tipo_persona'), ['class' => 'form-select', 'id' => 'id_tipo_persona', 'required'=>'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('id_tipo_documento', collect(['' => 'Seleccionar...'])->union($tipos_documento), old('id_tipo_documento'), ['class' => 'form-select', 'id' => 'id_tipo_documento', 'required'=>'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_id_genero">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('id_genero', collect(['' => 'Seleccionar...'])->union($generos), old('id_genero'), ['class' => 'form-select', 'id' => 'id_genero']) !!}
                </div>
            </div>
        </div>
