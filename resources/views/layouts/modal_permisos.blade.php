...
<div class="modal fade modal-gral h-auto" id="modal_crear_permiso"
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-5">
                                <button type="submit" class="btn btn-success btn-sm" title="Guardar Rol" id="btn_crear_permiso">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-5">
                                <button type="button" class="btn btn-secondary btn-sm"
                                        title="Cancelar" data-bs-dismiss="modal" id="btn_cancelar_permiso">
