...
@section('content')
    ...
    <div class="d-flex p-0">
        ...
        <div class="p-3 d-flex flex-column" style="width: 80%">
            ...
            <div class="modal fade" id="modalAyudaListarPersonas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard ="false" data-backdrop = "static">
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        {!! Form::select(
                                                                            ...
                                                                            ['class' => 'form-select', 'id' => 'id_tipo_persona'],
                                                                        ) !!}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        {!! Form::select(
                                                                            ...
                                                                            ['class' => 'form-select', 'id' => 'id_estado'],
                                                                        ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>
