<div class="p-0" style="border: solid 1px #337AB7; border-radius: 5px 5px 0 0;">
    <h5 class="border rounded-top text-white text-center pt-2 pb-2 m-0" style="background-color: #337AB7">Registrar Proveedores (Obligatorios * )</h5>
        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('id_tipo_persona', collect(['' => 'Seleccionar...'])->union($tipos_proveedor), old('id_tipo_persona'), ['class' => 'form-select select2', 'id' => 'id_tipo_persona', 'required'=>'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('id_tipo_documento', collect(['' => 'Seleccionar...'])->union($tipos_documento), old('id_tipo_documento'), ['class' => 'form-select select2', 'id' => 'id_tipo_documento', 'required'=>'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_identificacion">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('identificacion', old('identificacion'), ['class' => 'form-control', 'id' => 'identificacion', 'minlength' => 6]) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_nombres_persona">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('nombres_proveedor', old('nombres_proveedor'), ['class' => 'form-control', 'id' => 'nombres_persona']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_apellidos_persona">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('apellidos_proveedor', old('apellidos_proveedor'), ['class' => 'form-control', 'id' => 'apellidos_persona']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_numero_telefono">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('telefono_proveedor', old('telefono_proveedor'), ['class' => 'form-control', 'id' => 'numero_telefono']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_celular">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('celular_proveedor', old('celular_proveedor'), ['class' => 'form-control', 'id' => 'celular']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_email">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('email_proveedor', old('email_proveedor'), ['class' => 'form-control', 'id' => 'email']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_direccion">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('direccion_proveedor', old('direccion_proveedor'), ['class' => 'form-control', 'id' => 'direccion']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_id_genero">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('id_genero', collect(['' => 'Seleccionar...'])->union($generos), old('id_genero'), ['class' => 'form-select select2', 'id' => 'id_genero']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5" id="div_proveedor_juridico">
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('nit_proveedor', old('nit_proveedor'), ['class' => 'form-control', 'id' => 'nit_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('proveedor_juridico', old('proveedor_juridico'), ['class' => 'form-control', 'id' => 'nombre_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('telefono_juridico', old('telefono_juridico'), ['class' => 'form-control', 'id' => 'telefono_empresa']) !!}
                </div>
            </div>
        </div>
