        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('nit_empresa', old('nit_empresa'), ['class' => 'form-control', 'id' => 'nit_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('nombre_empresa', old('nombre_empresa'), ['class' => 'form-control', 'id' => 'nombre_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('telefono_empresa', old('telefono_empresa'), ['class' => 'form-control', 'id' => 'telefono_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_celular">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('celular_empresa', old('celular_empresa'), ['class' => 'form-control', 'id' => 'celular_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_email">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::email('email_empresa', old('email_empresa'), ['class' => 'form-control', 'id' => 'email_empresa']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_direccion">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('direccion_empresa', old('direccion_empresa'), ['class' => 'form-control', 'id' => 'direccion_empresa']) !!}
                </div>
            </div>
