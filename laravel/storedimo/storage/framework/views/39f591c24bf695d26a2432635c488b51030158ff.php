...
<?php $__env->startSection('title', 'Crear Personas'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="d-flex p-0">
        ...
        <div class="p-3" style="width: 80%">
            ...
            <?php echo Form::open(['method' => 'POST', 'route' => ['personas.store'], 'class' => 'mt-2', 'autocomplete' => 'off', 'id' => 'formCrearPersonas']); ?>

                <?php echo csrf_field(); ?>
            
                <?php echo $__env->make('personas.fields_crear_personas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/personas/create.blade.php ENDPATH**/ ?>