    ...
    <div class="d-flex p-0">
        ...
        <div class="p-3 d-flex flex-column" style="width: 80%">
            <div class="d-flex justify-content-between pe-3 mt-2 mb-3">
                <div class="">
                    <a href="<?php echo e(route('productos.create')); ?>" class="btn text-white" style="background-color:#337AB7">Crear Producto</a>
                </div>
            ...
            <div class="p-0" style="border: solid 1px #337AB7; border-radius: 5px;">
                ...
                <div class="col-12 p-3" id="">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <?php if( $producto->id_estado == 1 || $producto->id_estado == "1" ): ?>
                                            <td>
                                                <button class="btn btn-success rounded-circle btn-circle"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalEditarProducto_<?php echo e($producto->id_producto); ?>"
                                                    title="Modificar">
                                                ...
                                                <button class="btn btn-warning rounded-circle btn-circle barcode"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#barCodeModal_<?php echo e($producto->id_producto); ?>"
                                                ...
                                                <button class="btn btn-danger rounded-circle btn-circle"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalCambiarEstadoProducto_<?php echo e($producto->id_producto); ?>"
                                        ...
                                        <div class="modal fade h-auto modal-gral p-0"
                                            id="modalEditarProducto_<?php echo e($producto->id_producto); ?>"
                                            tabindex="-1"
                                            role="dialog"
                                            ...
                                            <div class="modal-dialog m-0">
                                                <div class="modal-content p-3">
                                                    <?php echo Form::open(['method' => 'POST',
                                                                ...
                                                                <div class="row m-0 pt-4 pb-4">
                                                                    <div class="col-12 col-md-2">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('idProductoEdit', isset($producto) ? $producto->id_producto : null, ['class'=>'form-control', 'id'=>'idProductoEdit','required'=>'required', 'readonly'=>true ])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-5">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('nombreProductoEdit', isset($producto) ? $producto->nombre_producto : null, ['class' => 'form-control', 'id' => 'nombreProductoEdit','required'=>'required'])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-5">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo Form::select('categoriaEdit', collect(['' => 'Seleccionar...'])->union($categorias), isset($producto) ? $producto->id_categoria : null, ['class' => 'form-select', 'id' => 'categoriaEdit','required'=>'required']); ?>
                                                                    ...
                                                                    <div class="col-12 mt-md-3">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::textarea('descripcionEdit', isset($producto) ? $producto->descripcion : null,['class'=>'form-control', 'id'=>'descripcionEdit', 'rows' => 3, 'style' => 'resize: none;'])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-6 mt-md-3">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('precioUnitarioEdit', isset($producto) ? $producto->precio_unitario : null,['class'=>'form-control', 'id'=>'precioUnitarioEdit','required'=>'required'])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-6 mt-md-3">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('precioDetalEdit', isset($producto) ? $producto->precio_detal : null,['class'=>'form-control', 'id'=>'precioDetalEdit','required'=>'required'])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-6 mt-md-3">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('precioPorMayorEdit', isset($producto) ? $producto->precio_por_mayor : null,['class'=>'form-control', 'id'=>'precioPorMayorEdit','required'=>'required'])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-6 mt-md-3">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('stockMinimoEdit', isset($producto) ? $producto->stock_minimo : null,['class'=>'form-control', 'id'=>'stockMinimoEdit','required'=>'required'])); ?>
                                                        ...
                                                        <div id="loadingIndicatorEditProducto_<?php echo e($producto->id_producto); ?>"
                                                        ...
                                                        <div class="d-flex justify-content-center mt-3">
                                                            <button type="submit" title="Modificar" class="btn btn-success me-3" id="btn_editar_producto_<?php echo e($producto->id_producto); ?>">
                                                                <i class="fa fa-floppy-o" aria-hidden="true"> Modificar</i>
                                                            </button>
                                                            
                                                            <button type="button" title="Cancelar" class="btn btn-danger" data-bs-dismiss="modal" id="btn_cancelar_producto_<?php echo e($producto->id_producto); ?>">
                                        ...
                                        <div class="modal fade h-auto modal-gral p-0"
                                            id="barCodeModal_<?php echo e($producto->id_producto); ?>"
                                            tabindex="-1"
                                            role="dialog"
                                            aria-labelledby="myModalLabel"
                                            aria-hidden="true"
                                                ...
                                                <div class="modal-content p-3 w-100">
                                                    <?php echo Form::open(['method' => 'POST',
                                                        ...
                                                        <div class="rounded-top" style="border: solid 1px #337AB7;">
                                                            <div class="rounded-top text-white text-center" style="background-color: #337AB7; border: solid 1px #337AB7;">
                                                                <h5>Producto: <span id="nombre_producto"><?php echo e($producto->nombre_producto); ?></span> - Código: <span id="id_producto"><?php echo e($producto->id_producto); ?></span></h5>

                                                                <?php echo e(Form::hidden('id_producto_input', isset($producto) ? $producto->id_producto : null,['class'=>'','id'=>'id_producto_input','required'=>'required'])); ?>

                                                                <?php echo e(Form::hidden('nombre_producto_input', isset($producto) ? $producto->nombre_producto : null,['class'=>'form-control','id'=>'nombre_producto_input', 'required'=>'required'])); ?>
                                                            ...
                                                            <div class="modal-body p-0 m-0">
                                                                    <div class="m-0 p-4 d-flex justify-content-between">
                                                                        <div class="">
                                                                            <?php echo e(Form::number('cantidad_barcode',null,
                                                                            [
                                                                                'class'=>'form-control',
                                                                        ...
                                                                        <div class="">
                                                                            <button type="submit" class="btn btn-success" id="btn_codebar_producto_<?php echo e($producto->id_producto); ?>">
                                                        ...
                                                        <!-- Contenedor para el GIF -->
                                                        <div id="loadingIndicatorCodeBarProducto_<?php echo e($producto->id_producto); ?>"
                                                            class="loadingIndicator">
                                                            <img src="<?php echo e(asset('imagenes/loading.gif')); ?>" alt="Procesando...">
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-end mt-3">
                                                            <button type="button"
                                                                ...
                                                                id="btn_cancelar_codebar_<?php echo e($producto->id_producto); ?>">
                                                                <i class="fa fa-remove" aria-hidden="true"> Cancelar</i>
                                                            </button>
                                                        </div>
                                                    <?php echo Form::close(); ?>
                                        ...
                                        <div class="modal fade h-auto modal-gral" id="modalCambiarEstadoProducto_<?php echo e($producto->id_producto); ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
                                            <div class="modal-dialog m-0">
                                                <div class="modal-content w-100 border-0">
                                                    <?php echo Form::open([
                                                        ...
                                                        <div class="rounded-top" style="border: solid 1px #337AB7;">
                                                            <div class="rounded-top text-white text-center"
                                                                ...
                                                                <h5>Cambiar estado del producto: <br>
                                                                    <span class="text-warning"><?php echo e($producto->nombre_producto); ?></span>
                                                                </h5>
                                                            </div>
                                                            ...
                                                            <?php echo e(Form::hidden('id_producto', isset($producto) ? $producto->id_producto : null, ['class' => '', 'id' => 'id_producto'])); ?>
                                                        ...
                                                        <!-- Contenedor para el GIF -->
                                                        <div id="loadingIndicatorEstadoProducto_<?php echo e($producto->id_producto); ?>"
                                                            class="loadingIndicator">
                                                            <img src="<?php echo e(asset('imagenes/loading.gif')); ?>" alt="Procesando...">
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-around mt-3">
                                                            <button type="submit" id="btn_cambiar_estado_producto_<?php echo e($producto->id_producto); ?>"
                                                                class="btn btn-success" title="Guardar Configuración">
                                                                <i class="fa fa-floppy-o" aria-hidden="true"> Modificar</i>
                                                            </button>


                                                            <button type="button" id="btn_cancelar_estado_producto_<?php echo e($producto->id_producto); ?>"
                    ...
                    <div class="mt-5 mb-2 d-flex justify-content-center">
                        <a href="<?php echo e(route('reporte_productos_pdf')); ?>" target="_blank" class="btn rounded-2 me-3 text-white" style="background-color: #286090">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            let pdfUrl = "<?php echo e(session('pdfUrl')); ?>";
            if (pdfUrl) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/productos/index.blade.php ENDPATH**/ ?>