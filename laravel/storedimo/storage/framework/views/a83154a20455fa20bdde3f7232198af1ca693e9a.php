        ...
        <ul class="nav navbar-nav d-flex flex-column justify-content-center flex-nowrap" id="sidebarnav">
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_usuarios">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('usuarios.create')); ?>">Registrar Usuarios</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('usuarios.index')); ?>">Listar Usuarios</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_empresas">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('empresas.create')); ?>">Registrar Empresas</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('empresas.index')); ?>">Listar Empresas</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_personas">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('listar_clientes')); ?>">Listar Clientes</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('listar_proveedores')); ?>">Listar Proveedores</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('personas.create')); ?>">Registrar Cliente-Proveedor</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_categorias">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('categorias.index')); ?>">Gestionar Categorías</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_productos">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('productos.create')); ?>">Registrar Productos</a>
                    </li>
                    <li class="nav-item  w-100">
                        <a class="link-underline-light" href="<?php echo e(route('productos.index')); ?>">Listar Productos</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_existencias">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('existencias.create')); ?>">Registrar Bajas</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('bajas_index')); ?>">Listar Bajas</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('stock_minimo')); ?>">Listar Productos en stock Mínimo</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_entradas">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('entradas.create')); ?>">Registrar Compras</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('entradas.index')); ?>">Listar Compras</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_ventas">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('ventas.create')); ?>">Registrar Ventas</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('ventas.index')); ?>">Listar Ventas</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('credito_ventas')); ?>">Listar Créditos-Abonos</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_pestamos_empleados">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('prestamos.create')); ?>">Registrar Préstamos</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('prestamos.index')); ?>">Listar Préstamos</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item pt-1 pb-1 d-flex flex-column" style="border-bottom: 1px solid #e7e7e7">
                ...
                <ul class="nav collapse navbar-collapse ps-3" id="ul_pago_empleados">
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('pago_empleados.create')); ?>">Registrar Pagos</a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="link-underline-light" href="<?php echo e(route('pago_empleados.index')); ?>">Listar Pagos</a>
                    </li>
                </ul>
            </li>
        </ul>
