<div class="p-0" style="border: solid 1px #337AB7; border-radius: 5px 5px 0 0;">
    ...
    <div class="row m-0 p-3" id="div_campos_usuarios">
        <?php echo Form::hidden('id_usuario', isset($usuario) ? $usuario->id_usuario : null, [
            'class' => '',
            'id' => 'id_usuario',
            'required' => 'required'
        ]); ?>
        ...
        <div class="col-12 col-md-3 mt-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::select('id_tipo_persona', collect(['' => 'Seleccionar...'])->union($tipos_empleado), null, [
                    'class' => 'form-select',
                    'id' => 'id_tipo_persona',
                    'required' => 'required'
                ]); ?>
        ...
        <div class="col-12 col-md-3 mt-3">
            <div class="form-group d-flex flex-column">
                <label for="identificacion" class="form-label">Número de documento <span
                        class="text-danger">*</span></label>
                <?php echo Form::text('identificacion', isset($usuario) ? $usuario->identificacion : null, [
                    'class' => 'form-control',
                    'id' => 'identificacion',
                    'minlength' => 6,
                    'required' => 'required'
        ...
        <div class="col-12 col-md-3 mt-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::text('nombre_usuario', isset($usuario) ? $usuario->nombre_usuario : null, [
                    'class' => 'form-control',
                    'id' => 'nombre_usuario',
                    'required' => 'required'
                ]); ?>
        ...
        <div class="col-12 col-md-3 mt-4">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::text('apellido_usuario', isset($usuario) ? $usuario->apellido_usuario : null, [
                    'class' => 'form-control',
                    'id' => 'apellido_usuario',
                    'required' => 'required'
                ]); ?>
        ...
        <div class="col-12 col-md-3 mt-4">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::text('numero_telefono', null, [
        ...
        <div class="col-12 col-md-3 mt-4">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::text('celular', null, ['class' => 'form-control', 'id' => 'celular','required' => 'required']); ?>
        ...
        <div class="col-12 col-md-3 mt-4">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::email('email', isset($usuario) ? $usuario->email : null, [
        ...
        <div class="col-12 col-md-3 mt-4">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::select('id_genero', collect(['' => 'Seleccionar...'])->union($generos), null, [
                    'class' => 'form-select',
                    'id' => 'id_genero',
                    'required' => 'required'
                ]); ?>
        ...
        <div class="col-12 col-md-3 mt-4">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::date('fecha_contrato', null, ['class' => 'form-control', 'id' => 'fecha_contrato','required' => 'required']); ?>
        ...
        <div class="col-12 col-md-3 mt-4" id="div_fecha_terminacion_contrato">
            <div class="form-group d-flex flex-column">
                <label for="fecha_terminacion_contrato" class="form-label">Fecha terminación contrato<span
                        class="text-danger">*</span></label>
                <?php echo Form::date('fecha_terminacion_contrato', null, [
                    'class' => 'form-control',
...
<?php /**PATH /var/www/html/resources/views/usuarios/fields_usuarios.blade.php ENDPATH**/ ?>