    ...
    <div class="row m-0 p-3" id="div_campos_usuarios">
        ...
        <div class="col-12 col-md-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::text('nombre_producto', null, ['class' => 'form-control', 'id' => 'nombre_producto']); ?>
        ...
        <div class="col-12 col-md-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::select('id_categoria', collect(['' => 'Seleccionar...'])->union($categorias), null, ['class' => 'form-select', 'id' => 'id_categoria']); ?>
        ...
        <div class="col-12 col-md-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::number('precio_unitario', null, ['class' => 'form-control', 'id' => 'precio_unitario', 'min' => 0, 'oninput' => 'validity.valid||(value=\'\');']); ?>
        ...
        <div class="col-12 col-md-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::number('precio_detal', null, ['class' => 'form-control', 'id' => 'precio_detal', 'min' => 0, 'oninput' => 'validity.valid||(value=\'\');']); ?>
        ...
        <div class="col-12 col-md-3 mt-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::number('precio_por_mayor', null, ['class' => 'form-control', 'id' => 'precio_por_mayor', 'min' => 0, 'oninput' => 'validity.valid||(value=\'\');']); ?>
        ...
        <div class="col-12 col-md-3 mt-3">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::text('descripcion', null, ['class' => 'form-control', 'id' => 'descripcion']); ?>
        ...
        <div class="col-12 col-md-3 mt-3" id="">
            <div class="form-group d-flex flex-column">
                ...
                <?php echo Form::number('stock_minimo', null, ['class' => 'form-control', 'id' => 'stock_minimo', 'min' => 1, 'max' => 50, 'oninput' => 'validity.valid||(value=\'\');']); ?>
...
<?php /**PATH /var/www/html/resources/views/productos/fields_crear_productos.blade.php ENDPATH**/ ?>