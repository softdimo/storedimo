            ...
            <div class="p-0" style="border: solid 1px #337AB7; border-radius: 5px;">
                ...
                <div class="d-flex justify-content-between p-3">
                    <div class="col-12 mb-auto" style="border: solid 1px #337AB7; border-radius: 5px; width:30%">
                        ...
                        <?php echo Form::open(['method' => 'POST', 'route' => ['categorias.store'], 'class' => 'mt-2', 'autocomplete' => 'off', 'id' => 'formCrearCategoria']); ?>
                            ...
                            <div class="p-3 d-flex flex-column" style="height: 50%;">
                                <div>
                                    ...
                                    <?php echo Form::text('categoria', null, ['class' => 'form-control', 'id' => 'categoria', 'required' => 'required']); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success rounded-circle btn-circle" id="btn_editar_<?php echo e($categoria->id_categoria); ?>" title="Modificar" data-bs-toggle="modal" data-bs-target="#modal_editar_categoria_<?php echo e($categoria->id_categoria); ?>">
                                            ...
                                            <div class="modal fade h-auto modal-gral" id="modal_editar_categoria_<?php echo e($categoria->id_categoria); ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content p-3 w-100">
                                                        <?php echo Form::open(['method' => 'POST',
                                                                    ...
                                                                    <div class="row m-0 pt-4 pb-4">
                                                                            <div class="col-12 col-md-3">
                                                                                <div class="form-group d-flex flex-column">
                                                                                    ...
                                                                                    <?php echo e(Form::text('id_categoria',
                                                                            ...
                                                                            <div class="col-12 col-md-9">
                                                                                <div class="form-group d-flex flex-column">
                                                                                    ...
                                                                                    <?php echo e(Form::text('categoria',
                                                            ...
                                                            <!-- Contenedor para el GIF -->
                                                            <div id="loadingIndicatorEditCategoria_<?php echo e($categoria->id_categoria); ?>"
                                                                class="loadingIndicator">
                                                                <img src="<?php echo e(asset('imagenes/loading.gif')); ?>" alt="Procesando...">
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-around mt-5">
                                                                <button type="submit" title="Guardar Configuración"
                                                                    ...
                                                                    id="btn_editar_categoria_<?php echo e($categoria->id_categoria); ?>">
                                                                ...
                                                                <button type="button" title="Cancelar"
                                                                    ...
                                                                    id="btn_editar_cancelar_<?php echo e($categoria->id_categoria); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/categorias/index.blade.php ENDPATH**/ ?>