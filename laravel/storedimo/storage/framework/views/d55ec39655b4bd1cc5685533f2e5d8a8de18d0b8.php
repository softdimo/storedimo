...
<?php $__env->startSection('title', 'Registrar Productos'); ?>
    ...
    <div class="d-flex p-0">
        ...
        <div class="p-3" style="width: 80%">
            <div class="d-flex justify-content-between pe-3 mt-2 mb-3">
                <div class="">
                    <a href="<?php echo e(route('productos.index')); ?>" class="btn text-white" style="background-color:#337AB7">Productos</a>
                </div>
            ...
            <?php echo Form::open(['method' => 'POST', 'route' => ['productos.store'], 'class' => 'mt-2', 'autocomplete' => 'off', 'id' => 'formCrearProducto']); ?>

                <?php echo csrf_field(); ?>
            
                <?php echo $__env->make('productos.fields_crear_productos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::close(); ?>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('#id_categoria').blur(function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('verificar_producto')); ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/productos/create.blade.php ENDPATH**/ ?>