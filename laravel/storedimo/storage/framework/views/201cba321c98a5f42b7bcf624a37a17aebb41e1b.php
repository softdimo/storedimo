                        ...
                        <table class="table table-striped table-bordered w-100 mb-0" id="tbl_proveedores" aria-describedby="proveedores">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $personaIndex; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($persona->id_tipo_persona == 3 || $persona->id_tipo_persona == 4): ?>
                                        <tr class="text-center">
                                            <td><?php echo e($persona->tipo_persona); ?></td>
                                            <td><?php echo e($persona->nombre_empresa); ?></td>
                                            <td><?php echo e($persona->nit_empresa); ?></td>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success rounded-circle btn-circle"
                                                    ...
                                                    data-bs-target="#modalEditarProveedor_<?php echo e($persona->id_persona); ?>">
                                            ...
                                            <div class="modal fade h-auto modal-gral"
                                                id="modalEditarProveedor_<?php echo e($persona->id_persona); ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content w-100 border-0">
                                                        <?php echo Form::model($persona,[
                                                                ...
                                                                <div class="row m-4">
                                                                    ...
                                                                    <div class="col-12 col-md-4"  id="div_identificacion">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('identificacion',
                                                                    ...
                                                                    <div class="col-12 col-md-4 mt-4" id="div_nombres_persona">
                                                                        <div class="form-group d-flex flex-column">
                                                                            <label for="nombre_usuario" class="" style="font-size: 15px">Nombres
                                                                                <span class="text-danger">*</span></label>
                                                                            <?php echo e(Form::text('nombres_persona',
                                                                    ...
                                                                    <div class="col-12 col-md-4 mt-4" id="div_apellidos_persona">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('apellidos_persona',
                                                                    ...
                                                                    <div class="col-12 col-md-4 mt-4" id="div_numero_telefono">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('numero_telefono',
                                                                ...
                                                                <div class="row m-4" id="div_proveedor_juridico">
                                                                    <div class="col-12 col-md-4">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo Form::text('nit_empresa', null, ['class' => 'form-control', 'id' => 'nit_empresa']); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-4">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo Form::text('nombre_empresa', null, ['class' => 'form-control', 'id' => 'nombre_empresa']); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-4">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo Form::text('telefono_empresa', null, ['class' => 'form-control', 'id' => 'telefono_empresa']); ?>
                                                            ...
                                                            <div class="modal-footer d-block mt-0 border border-0">
                                                                ...
                                                                <div id="loadingIndicatorEditProveedor_<?php echo e($persona->id_persona); ?>"
                                                                ...
                                                                <div class="d-flex justify-content-around mt-3">
                                                                    <button type="submit" id="btn_editar_proveedor_<?php echo e($persona->id_persona); ?>"
                                                                        class="btn btn-success">
                                                                        <i class="fa fa-floppy-o" aria-hidden="true"> Modificar</i>
                                                                    </button>

                                                                    <button id="btn_cancelar_proveedor_<?php echo e($persona->id_persona); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/personas/listar_proveedores.blade.php ENDPATH**/ ?>