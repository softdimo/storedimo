                        ...
                        <table class="table table-striped table-bordered w-100 mb-0" id="tbl_clientes" aria-describedby="clientes">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $personaIndex; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($persona->id_tipo_persona == 5 || $persona->id_tipo_persona == 6): ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success rounded-circle btn-circle"
                                                    ...
                                                    data-bs-target="#modalEditarCliente_<?php echo e($persona->id_persona); ?>">
                                            ...
                                            <div class="modal fade h-auto modal-gral"
                                                id="modalEditarCliente_<?php echo e($persona->id_persona); ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content w-100 border-0">
                                                        <?php echo Form::model($persona,[
                                                                ...
                                                                <div class="row m-4">
                                                                    ...
                                                                    <div class="col-12 col-md-4 mt-4" id="div_numero_telefono">
                                                                        <div class="form-group d-flex flex-column">
                                                                            ...
                                                                            <?php echo e(Form::text('numero_telefono', isset($persona) ? $persona->numero_telefono : null, ['class' => 'form-control', 'id' => 'numero_telefono'])); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-4 mt-4" id="div_email">
                                                                        <div class="form-group d-flex flex-column">
                                                                            <label for="email" class="" style="font-size: 15px">Correo
                                                                                <span class="text-danger">*</span></label>
                                                                            <?php echo e(Form::email('email', isset($persona) ? $persona->email : null, ['class' => 'form-control', 'id' => 'email', 'required' => 'required'])); ?>
                                                            ...
                                                            <div class="modal-footer d-block mt-0 border border-0">
                                                                ...
                                                                <div id="loadingIndicatorEditCliente_<?php echo e($persona->id_persona); ?>"
                                                                ...
                                                                <div class="d-flex justify-content-around mt-3">
                                                                    <button type="submit" id="btn_editar_cliente_<?php echo e($persona->id_persona); ?>"
                                                                        class="btn btn-success">
                                                                        <i class="fa fa-floppy-o" aria-hidden="true"> Modificar</i>
                                                                    </button>

                                                                    <button id="btn_cancelar_cliente_<?php echo e($persona->id_persona); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/personas/listar_clientes.blade.php ENDPATH**/ ?>