...
<?php $__env->startSection('title', 'Listar Compras'); ?>
...
<?php $__env->startSection('content'); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $entradas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?php echo e($entrada->id_compra); ?></td>
                                        <td><?php echo e($entrada->valor_compra); ?></td>
                                        <td><?php echo e($entrada->fecha_compra); ?></td>

                                        <?php if($entrada->nit_empresa): ?>
                                            <td><?php echo e($entrada->nit_empresa); ?></td>
                                        <?php else: ?>
                                         <td><?php echo e($entrada->identificacion); ?></td>
                                        <?php endif; ?>

                                        <?php if($entrada->nombre_empresa): ?>
                                            <td><?php echo e($entrada->nombre_empresa); ?></td>
                                        <?php else: ?>
                                            <td><?php echo e($entrada->nombres_persona); ?> <?php echo e($entrada->apellidos_persona); ?></td>
                                        <?php endif; ?>
                                        
                                        <td><?php echo e($entrada->estado); ?></td>

                                        <?php if($entrada->id_estado == 1): ?>
                                            <td>
                                                <button title="Ver Detalles"
                                                    class="btn rounded-circle btn-circle text-white"
                                                    style="background-color: #286090"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalDetalleEntrada_<?php echo e($entrada->id_compra); ?>">
                                                ...
                                                <button title="Anular"
                                                    ...
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalAnularCompra_<?php echo e($entrada->id_compra); ?>">
    ...
    <?php $__currentLoopData = $entradas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal fade h-auto modal-gral p-0" id="modalDetalleEntrada_<?php echo e($entrada->id_compra); ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog m-0">
                <div class="modal-content p-3 w-100">
                    <div class="rounded-top" style="border: solid 1px #337AB7;">
                        <div class="rounded-top text-white text-center" style="background-color: #337AB7; border: solid 1px #337AB7;">
                            <h5>Detalle de Compra Código: <?php echo e($entrada->id_compra); ?></h5>
                        </div>

                        <div class="mt-3 mb-0 ps-3">
                            <h6>Compra realizada por: <span class="" style="color: #337AB7"><?php echo e($entrada->nombres_usuario); ?></span></h6>
                        </div>
                                    ...
                                    <div class="col-12 p-3 pt-1">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered w-100 mb-0" aria-describedby="compra_detalle">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $entrada->detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="text-center">
                                                            <td><?php echo e($producto->nombre_producto); ?></td>
                                                            <td><?php echo e($producto->cantidad); ?></td>
                                                            <td><?php echo e($producto->precio_unitario_compra); ?></td>
                                                            <td><?php echo e($producto->subtotal); ?></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
                    ...
                    <div class="d-flex justify-content-around mt-3">
                        <a href="<?php echo e(route('detalle_compras_pdf', $entrada->id_compra)); ?>" target="_blank" class="btn btn-success" style="background-color: #337AB7">
        ...
        <!-- Modal Anular compra -->
        <div class="modal fade h-auto modal-gral p-0" id="modalAnularCompra_<?php echo e($entrada->id_compra); ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog m-0">
                <div class="modal-content p-3 w-100">
                    <?php echo Form::open(['method' => 'POST',
                        'route' => ['anular_compra'],
                        ...
                        <?php echo e(Form::hidden('id_compra',isset($entrada) ? $entrada->id_compra : null,['class'=>'','id'=>'id_compra_'.$entrada->id_compra])); ?>
                        ...
                        <div class="rounded-top" style="border: solid 1px #337AB7;">
                            ...
                            <div class="modal-body p-0 m-0">
                                <div class="mt-3 mb-3 mb-0 ps-3 text-center">
                                    ...
                                    <h4 class="mt-4" style="color: #337AB7"> <?php echo e($entrada->id_compra); ?> - <?php echo e($entrada->nombre_producto); ?></h4>
                                </div>
                            </div>
                        </div>

                        <div id="loadingIndicatorAnularCompra_<?php echo e($entrada->id_compra); ?>" class="loadingIndicator">
                            <img src="<?php echo e(asset('imagenes/loading.gif')); ?>" alt="Procesando...">
                        </div>

                        <div class="d-flex justify-content-around mt-3">
                            <button type="submit" class="btn btn-success" id="btn_anular_compra_<?php echo e($entrada->id_compra); ?>" style="background-color: #337AB7">
                                <i class="fa fa-file-pdf-o"> Anular</i>
                            </button>
                            
                            <button type="button" class="btn btn-secondary" id="btn_cancelar_compra_<?php echo e($entrada->id_compra); ?>" data-bs-dismiss="modal">
                                <i class="fa fa-times" aria-hidden="true"> Cerrar</i>
                            </button>
                        </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/entradas/index.blade.php ENDPATH**/ ?>