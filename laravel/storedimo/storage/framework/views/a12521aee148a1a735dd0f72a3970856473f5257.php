        ...
        <div class="row p-0 w-100 align-items-lg-center justify-content-between">
            <div class="logo-container col-4 col-md-2 text-center">
                <a class="w-100" href="/home">
                    <img src="<?php echo e(asset('imagenes/logo_storedimo.png')); ?>" alt="Logo" width="140" height="50" class="text-center">
                </a>
            </div>
                    ...
                    <ul class="navbar-nav justify-content-between">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-white" style="right:0;left:auto">
                                ...
                                <?php if(!is_null(session('sesion_iniciada')) && session('id_rol') == 3): ?>
                                    <li class="nav-item" data-bs-toggle="modal" data-bs-target="#modal_configurar_permisos">
                                        <a href="<?php echo e(route('permisos.index')); ?>" class="dropdown-item text-dark hover-li">Asignación de Permisos</a>
                                    </li>
                                <?php else: ?>
                                    <p>&nbsp;</p>
                                <?php endif; ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-white" style="right:0;left:auto">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('stock_minimo')); ?>" class="dropdown-item text-dark hover-li"><i class="fa fa-cubes fa-fw"></i> Hay productos por debajo del stock mínimo</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('prestamos_vencer')); ?>" class="dropdown-item text-dark hover-li"><i class="fa fa-money fa-fw"></i> Hay Préstamos a punto de vencer</a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <?php if(session('sesion_iniciada')): ?>
                                <ul class="dropdown-menu bg-white" style="right:0;left:auto">
                                    <li class="dropdown-item text-dark hover-li">
                                        <i class="fa fa-user fa-fw fa-1x"></i> <?php echo e($usuarioLogueado->rol); ?>

                                        <h6 class="text-danger"><?php echo e($usuarioLogueado->nombre_usuario); ?> <?php echo e($usuarioLogueado->apellido_usuario); ?></h6>
                                    </li>

                                    <li class="dropdown-item text-dark hover-li">
                                        <i class="fa fa-sign-out fa-fw fa-1x">
                                            <a href="<?php echo e(route('logout')); ?>" class="" style="text-decoration: none;">Cerrar Sesión</a>
                                        </i>
                                    </li>
                                </ul>
                            <?php else: ?>
                    ...
                    <div class="row m-0 p-0">
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::date('fecha_inicial', null, ['class'=>'form-control', 'id'=>'fecha_inicial'])); ?>
                        ...
                        <div class="col-12 col-md-6 form-group d-flex flex-column">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::date('fecha_final', null,['class' => 'form-control', 'id' => 'fecha_final'])); ?>
                    ...
                    <div class="row m-0 pt-4 pb-4">
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('v_minimo_subtotal', null, ['class'=>'form-control', 'id'=>'v_minimo_subtotal'])); ?>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('p_minimo_descuento', null,['class' => 'form-control', 'id' => 'p_minimo_descuento'])); ?>
                        ...
                        <div class="col-12 col-md-6 mt-md-3">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('v_maximo_subtotal', null, ['class'=>'form-control', 'id'=>'v_maximo_subtotal'])); ?>
                        ...
                        <div class="col-12 col-md-6 mt-md-3">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('p_maximo_descuento', null,['class'=>'form-control', 'id'=>'p_maximo_descuento'])); ?>
                    ...
                    <div class="row m-0 pt-4 pb-4">
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('v_base_liquidacion', null, ['class'=>'form-control', 'id'=>'v_base_liquidacion'])); ?>

                            </div>
                        </div>

                        <?php if(!is_null(session('sesion_iniciada'))): ?>
                            <div class="col-12 col-md-6">
                                <div class="form-group d-flex flex-column">
                                    <label for="periodo_pago" class="" style="font-size: 15px">Período de Pago<span class="text-danger">*</span></label>
                                    <?php echo e(Form::select('periodo_pago', collect(['' => 'Seleccionar...'])->union($periodos_pago), null, ['class' => 'form-select', 'id' => 'periodo_pago'])); ?>
                            ...
                            <div class="col-12 col-md-6 mt-md-3">
                                <div class="form-group d-flex flex-column">
                                    ...
                                    <?php echo e(Form::select('porcentaje_comision', collect(['' => 'Seleccionar...'])->union($porcentajes_comision), null, ['class' => 'form-select', 'id' => 'porcentaje_comision'])); ?>
                        ...
                        <div class="col-12 col-md-6 mt-md-3">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('v_dia_empleado_fijo', null,['class'=>'form-control', 'id'=>'v_dia_empleado_fijo'])); ?>
                        ...
                        <div class="col-12 col-md-6 mt-md-3">
                            <div class="form-group d-flex flex-column">
                                ...
                                <?php echo e(Form::text('v_día_empleado_temporal', null,['class'=>'form-control', 'id'=>'v_día_empleado_temporal'])); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        fetch("<?php echo e(route('alerta_stock_minimo_app')); ?>", {
            method: "GET",
            headers: {
