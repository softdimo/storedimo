                ...
                <div class="col-12 p-3" id="">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-100 mb-0" id="tbl_personas"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $personaIndex; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        <td><?php echo e($persona->identificacion); ?></td>
                                        <td><?php echo e($persona->nombres_persona); ?></td>
                                        <td><?php echo e($persona->apellidos_persona); ?></td>
                                        ...
                                        <td><?php echo e($persona->fecha_contrato); ?></td>
                                        <td><?php echo e($persona->fecha_terminacion_contrato); ?></td>
                                        <td>
                                            <a href="#modalEditarPersona_<?php echo e($persona->id_persona); ?>"
                                                id="verModal_<?php echo e($persona->id_persona); ?>" rel="modal:open">
                                            ...
                                            <a href="#ex1_<?php echo e($persona->id_persona); ?>" rel="modal:open">
                                                <button class="btn btn-info">JQueryModal<?php echo e($persona->id_persona); ?></button>
                                            </a>
                                        </td>
                                        ...
                                        <div id="ex1_<?php echo e($persona->id_persona); ?>" class="modal h-auto modal-gral">
                                            <p>JQuery Modal</p>
                                        ...
                                        <div class="modal h-auto modal-gral" style="max-width: 55%"
                                            id="modalEditarPersona_<?php echo e($persona->id_persona); ?>" rel="modal:close">
                                            ...
                                            <div class="modal-dialog mw-100  m-0">
                                                <div class="modal-content w-100 border-0">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <?php echo e(Form::hidden('id_persona', isset($persona) ? $persona->id_persona : null, ['class' => '', 'id' => 'id_persona'])); ?>
                                                        ...
                                                        <div class="modal-body p-0 m-0">
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="identificacion" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('identificacion', isset($persona) ? $persona->identificacion : null, ['class' => 'form-control', 'id' => 'identificacion', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="nombres_persona" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('nombres_persona', isset($persona) ? $persona->nombres_persona : null, ['class' => 'form-control', 'id' => 'nombres_persona', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="apellidos_persona" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('apellidos_persona', isset($persona) ? $persona->apellidos_persona : null, ['class' => 'form-control', 'id' => 'apellidos_persona', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="numero_telefono" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo Form::text('numero_telefono', isset($persona) ? $persona->numero_telefono : null, [
                                                                            'class' => 'form-control',
                                                                            'id' => 'numero_telefono',
                                                                        ]); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="celular" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('celular', isset($persona) ? $persona->celular : null, ['class' => 'form-control', 'id' => 'celular', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="email" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('email', isset($persona) ? $persona->email : null, ['class' => 'form-control', 'id' => 'email', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="direccion" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('direccion', isset($persona) ? $persona->direccion : null, ['class' => 'form-control', 'id' => 'direccion', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="fecha_contrato" class=""
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo Form::date('fecha_contrato', isset($persona) ? $persona->fecha_contrato : null, [
                                                                            'class' => 'form-control',
                                                                            'id' => 'fecha_contrato',
                                                                        ]); ?>
                                                                ...
                                                                <div class="col-12 col-md-4 mt-3">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="fecha_terminacion_contrato"
                                                                            ...
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo Form::date('fecha_terminacion_contrato', isset($persona) ? $persona->fecha_terminacion_contrato : null, [
                                                                            'class' => 'form-control',
                                                            ...
                                                            <div id="loadingIndicatorEdit_<?php echo e($persona->id_persona); ?>"
                                                                class="loadingIndicator">
                                                                <img src="<?php echo e(asset('imagenes/loading.gif')); ?>"
                                                                    alt="Procesando...">
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-around mt-3">
                                                                <button id="btn_editar_<?php echo e($persona->id_persona); ?>"
                                                                ...
                                                                <button id="btn_cancelar_<?php echo e($persona->id_persona); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/personas/index.blade.php ENDPATH**/ ?>