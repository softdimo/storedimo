...
<?php $__env->startSection('title', 'Registrar Préstamos Empleados'); ?>
                ...
                <div class="col-12 p-3" id="">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-100 mb-0" id="tbl_registrar_prestamo" aria-describedby="registrar_prestamo">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $usuariosPrestamosCreate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuarioPrestamo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        <td><?php echo e($usuarioPrestamo->identificacion); ?></td>
                                        <td><?php echo e($usuarioPrestamo->nombre_usuario); ?></td>
                                        <td><?php echo e($usuarioPrestamo->apellido_usuario); ?></td>
                                        <td><?php echo e($usuarioPrestamo->tipo_persona); ?></td>
                                        <td><?php echo e($usuarioPrestamo->estado); ?></td>
                                        <td>
                                            <button class="btn rounded-circle btn-circle text-white" title="Registrar Préstamo" style="background-color: #286090" data-bs-toggle="modal" data-bs-target="#modalRegistrarPrestamo_<?php echo e($usuarioPrestamo->id_usuario); ?>">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>

                                        
                                        <div class="modal fade h-auto modal-gral p-0" id="modalRegistrarPrestamo_<?php echo e($usuarioPrestamo->id_usuario); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body pt-0">
                                                        ...
                                                        <?php echo Form::open([
                                                            ...
                                                            <?php echo Form::hidden('id_usuario', isset($usuarioPrestamo) ? $usuarioPrestamo->id_usuario : null, ['class' => 'form-control', 'id' => 'id_usuario', 'required']); ?>
                                                            ...
                                                            <div class="p-3" style="border: solid 1px #337AB7;" id="precios">
                                                                <div class="row">
                                                                    <div class="col-12 col-md-6">
                                                                        ...
                                                                        <?php echo Form::text('identificacion', isset($usuarioPrestamo) ? $usuarioPrestamo->identificacion : null, ['class' => 'form-control bg-secondary-subtle', 'id' => 'identificacion', 'required', 'readonly' => 'readonly']); ?>

                                                                    </div>

                                                                    <div class="col-12 col-md-6">
                                                                        <label for="id_tipo_persona" class="fw-bold" style="font-size: 12px">Tipo Empleado <span class="text-danger">*</span></label>
                                                                        <?php echo Form::text('id_tipo_persona', isset($usuarioPrestamo) ? $usuarioPrestamo->tipo_persona : null, ['class' => 'form-control bg-secondary-subtle', 'id' => 'id_tipo_persona', 'required', 'readonly' => 'readonly']); ?>

                                                                    </div>

                                                                    <div class="col-12 col-md-6 mt-3">
                                                                        <label for="fecha_prestamo" class="fw-bold" style="font-size: 12px">Fecha Préstamo <span class="text-danger">*</span></label>
                                                                        <?php echo Form::date('fecha_prestamo', null, ['class' => 'form-control', 'id' => 'fecha_prestamo', 'required']); ?>
                                                                    ...
                                                                    <div class="col-12 col-md-6 mt-3">
                                                                        ...
                                                                        <?php echo Form::text('valor_prestamo', null, ['class' => 'form-control', 'id' => 'valor_prestamo', 'required']); ?>

                                                                    </div>

                                                                    <div class="col-12 col-md-6 mt-3">
                                                                        <label for="descripcion" class="fw-bold" style="font-size: 12px">Descripción <span class="text-danger">*</span></label>
                                                                        <?php echo Form::textarea('descripcion', null, ['class' => 'form-control', 'id' => 'descripcion', 'required','rows'=>'2']); ?>
                                                        ...
                                                        <div id="loadingIndicatorRegistrarPrestamo_<?php echo e($usuarioPrestamo->id_usuario); ?>" class="loadingIndicator">
                                                        ...
                                                        <div class="modal-footer border-0 justify-content-center">
                                                            <div class="">
                                                                <button type="submit" class="btn btn-success" id="btn_registar_prestamo_<?php echo e($usuarioPrestamo->id_usuario); ?>">
                                                                    <i class="fa fa-floppy-o" aria-hidden="true"> Registrar</i>
                                                                </button>
                                                            </div>

                                                            <div class="">
                                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="btn_cancelar_prestamo_<?php echo e($usuarioPrestamo->id_usuario); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/prestamos/create.blade.php ENDPATH**/ ?>