        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::select('id_tipo_persona', collect(['' => 'Seleccionar...'])->union($tipos_persona), null, ['class' => 'form-select', 'id' => 'id_tipo_persona', 'required'=>'required']); ?>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::select('id_tipo_documento', collect(['' => 'Seleccionar...'])->union($tipos_documento), null, ['class' => 'form-select', 'id' => 'id_tipo_documento', 'required'=>'required']); ?>
            ...
            <div class="col-12 col-md-3" id="div_identificacion">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::text('identificacion', null, ['class' => 'form-control', 'id' => 'identificacion', 'minlength' => 6]); ?>
            ...
            <div class="col-12 col-md-3" id="div_nombres_persona">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::text('nombres_persona', null, ['class' => 'form-control', 'id' => 'nombres_persona']); ?>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_apellidos_persona">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::text('apellidos_persona', null, ['class' => 'form-control', 'id' => 'apellidos_persona']); ?>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_numero_telefono">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::text('numero_telefono', null, ['class' => 'form-control', 'id' => 'numero_telefono']); ?>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_celular">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::text('celular', null, ['class' => 'form-control', 'id' => 'celular']); ?>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_direccion">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::text('direccion', null, ['class' => 'form-control', 'id' => 'direccion']); ?>
            ...
            <div class="col-12 col-md-3 mt-3" id="div_id_genero">
                <div class="form-group d-flex flex-column">
                    ...
                    <?php echo Form::select('id_genero', collect(['' => 'Seleccionar...'])->union($generos), null, ['class' => 'form-select', 'id' => 'id_genero']); ?>
...
<?php /**PATH /var/www/html/resources/views/personas/fields_crear_personas.blade.php ENDPATH**/ ?>