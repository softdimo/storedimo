...
<?php $__env->startSection('content'); ?>
    <div class="d-flex p-0">
        ...
        <div class="p-3 d-flex flex-column" style="width: 80%">
            <div class="text-end">
                <a href="#" role="button" title="Ayuda" class="text-blue" data-bs-toggle="modal" data-bs-target="#modalAyudaListarUsuarios">
            ...
            <div class="modal fade h-auto modal-gral p-3" id="modalAyudaListarUsuarios" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard ="false" data-backdrop = "static" style="max-width: 55%;">
            ...
            <div class="p-0" style="border: solid 1px #337AB7; border-radius: 5px;">
                ...
                <div class="row pe-3 mt-3">
                    <div class="col-12 d-flex justify-content-end">
                        <a href="<?php echo e(route('usuarios.create')); ?>" class="btn text-white" style="background-color:#337AB7">Crear Usuario</a>
                    </div>
                </div>
                ...
                <div class="col-12 p-3" id="">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-100 mb-0" id="tbl_usuarios"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $usuarioIndex; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        <td><?php echo e($usuario->nombre_usuario); ?></td>
                                        <td><?php echo e($usuario->apellido_usuario); ?></td>
                                        <td><?php echo e($usuario->usuario); ?></td>
                                        <td><?php echo e($usuario->tipo_documento); ?></td>
                                        <td><?php echo e($usuario->identificacion); ?></td>
                                        <td><?php echo e($usuario->email); ?></td>
                                        <td><?php echo e($usuario->rol); ?></td>
                                        <td><?php echo e($usuario->tipo_persona); ?></td>
                                        <td><?php echo e($usuario->numero_telefono); ?></td>
                                        <td><?php echo e($usuario->celular); ?></td>
                                        <td><?php echo e($usuario->direccion); ?></td>
                                        <td><?php echo e($usuario->genero); ?></td>
                                        <td><?php echo e($usuario->fecha_contrato); ?></td>
                                        <td><?php echo e($usuario->estado); ?></td>
                                        <td><?php echo e($usuario->fecha_terminacion_contrato); ?></td>
                                        <td>
                                            <button type="button" class="btn btn-success rounded-circle btn-circle"
                                                title="Editar" data-bs-toggle="modal"
                                                data-bs-target="#modalEditarUsuario_<?php echo e($usuario->id_usuario); ?>">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            </button>

                                            <button type="button" class="btn btn-warning rounded-circle btn-circle"
                                                title="Cambiar contraseña" data-bs-toggle="modal"
                                                data-bs-target="#modal_cambiar_clave_<?php echo e($usuario->id_usuario); ?>">
                                        ...
                                        <div class="modal fade h-auto modal-gral"
                                            id="modal_cambiar_clave_<?php echo e($usuario->id_usuario); ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog m-0">
                                                <div class="modal-content w-100 border-0">
                                                    ...
                                                    <div class="" style="border: solid 1px #337AB7;">
                                                        <div class="rounded-top text-white text-center"
                                                            ...
                                                            <h5>Cambiar Contraseña de:
                                                                <?php echo e($usuario->identificacion . ' - ' . $usuario->nombre_usuario . ' ' . $usuario->apellido_usuario); ?>

                                                            </h5>
                                                        </div>

                                                        <?php echo e(Form::hidden('id_usuario', isset($usuario) ? $usuario->id_usuario : null, ['class' => '', 'id' => 'id_usuario', 'required' => 'required'])); ?>
                                                            ...
                                                            <div class="row m-0 pt-4 pb-4">
                                                                <div class="col-12 col-md-6">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo e(Form::text('nueva_clave', null, ['class' => 'form-control', 'id' => 'nueva_clave_' . $usuario->id_usuario, 'placeholder' => 'Contraseña', 'required'=>'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="confirmar_clave" class=""
                                                                            ...
                                                                            Contraseña<span
                                                                                class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('confirmar_clave', null, ['class' => 'form-control', 'id' => 'confirmar_clave_' . $usuario->id_usuario, 'placeholder' => 'Confirmar Contraseña', 'required'=>'required'])); ?>
                                                    ...
                                                    <div id="loadingIndicatorEditClave_<?php echo e($usuario->id_usuario); ?>"
                                                    ...
                                                    <div class="d-flex justify-content-around mt-2">
                                                        <button type="submit" title="Guardar Configuración" class="btn btn-success" id="btn_editar_clave_<?php echo e($usuario->id_usuario); ?>"
                                                            >
                                                            <i class="fa fa-floppy-o" aria-hidden="true"> Modificar</i>
                                                        </button>


                                                        <button type="button" title="Cancelar" class="btn btn-secondary" id="btn_cancelar_clave_<?php echo e($usuario->id_usuario); ?>"
                                        ...
                                        <div class="modal fade h-auto modal-gral"
                                            id="modalEditarUsuario_<?php echo e($usuario->id_usuario); ?>" tabindex="-1"
                                            data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"
                                            style="max-width: 55%;">
                                            <div class="modal-dialog m-0 mw-100">
                                                <div class="modal-content w-100 border-0">
                                                    <?php echo Form::model($usuario,[
                                                        ...
                                                        <?php echo e(Form::hidden('id_usuario', isset($usuario) ? $usuario->id_usuario : null, ['class' => '', 'id' => 'id_usuario'])); ?>
                                                            ...
                                                            <div class="row m-4">
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo e(Form::select('id_tipo_persona',
                                                                            collect(['' => 'Seleccionar...'])
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="id_tipo_documento" class="" style="font-size: 15px">Tipo de documento
                                                                                <span class="text-danger">*</span></label>
                                                                            <?php echo Form::select('id_tipo_documento',
                                                                                collect(['' => 'Seleccionar...'])
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="identificacion" class="" style="font-size: 15px">Número de documento
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('identificacion', isset($usuario) ? $usuario->identificacion : null, ['class' => 'form-control', 'id' => 'identificacion', 'required' => 'required'])); ?>
                                                            ...
                                                            <div class="row m-4">
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="nombre_usuario" class="" style="font-size: 15px">Nombre Usuario
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('nombre_usuario', isset($usuario) ? $usuario->nombre_usuario : null, ['class' => 'form-control', 'id' => 'nombre_usuario', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="apellido_usuario" class="" style="font-size: 15px">Apellido Usuario
                                                                                <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::text('apellido_usuario', isset($usuario) ? $usuario->apellido_usuario : null, ['class' => 'form-control', 'id' => 'apellido_usuario', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo e(Form::text('numero_telefono', isset($usuario) ? $usuario->numero_telefono : null, ['class' => 'form-control', 'id' => 'numero_telefono'])); ?>
                                                            ...
                                                            <div class="row m-4">
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo e(Form::text('celular',
                                                                            isset($usuario) ? $usuario->celular : null,
                                                                            [
                                                                                'class' => 'form-control',
                                                                                'id' => 'celular',
                                                                                'required' => 'required'
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="email" class="" style="font-size: 15px">Correo
                                                                            <span class="text-danger">*</span></label>
                                                                        <?php echo e(Form::email('email', isset($usuario) ? $usuario->email : null, ['class' => 'form-control', 'id' => 'email', 'required' => 'required'])); ?>
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="id_genero" class="" style="font-size: 15px">Género
                                                                                <span class="text-danger">*</span></label>
                                                                            <?php echo Form::select('id_genero',
                                                                                collect(['' => 'Seleccionar...'])
                                                                                ->union($generos),
                                                            ...
                                                            <div class="row m-4">
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo e(Form::text('direccion',
                                                                            isset($usuario) ? $usuario->direccion : null,
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo Form::select('id_estado',
                                                                            collect(['' => 'Seleccionar...'])
                                                                            ->union($estados),
                                                            ...
                                                            <div class="row m-4">
                                                                <div class="col-12 col-md-6">
                                                                    <div class="form-group d-flex flex-column">
                                                                        ...
                                                                        <?php echo Form::date('fecha_contrato',
                                                                ...
                                                                <div class="col-12 col-md-6" id="div_fecha_terminacion_contrato_<?php echo e($usuario->id_usuario); ?>">
                                                                    <div class="form-group d-flex flex-column">
                                                                        <label for="fecha_terminacion_contrato" class="form-label">Fecha terminación contrato
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <?php echo Form::date('fecha_terminacion_contrato',
                                                        ...
                                                        <div class="modal-footer d-block mt-0 border border-0">
                                                            <!-- Contenedor para el GIF -->
                                                            <div id="loadingIndicatorEditUser_<?php echo e($usuario->id_usuario); ?>"
                                                                class="loadingIndicator">
                                                                <img src="<?php echo e(asset('imagenes/loading.gif')); ?>" alt="Procesando...">
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-around mt-3">
                                                                <button id="btn_editar_user_<?php echo e($usuario->id_usuario); ?>" type="submit"
                                                                    class="btn btn-success" title="Guardar Configuración">
                                                                    <i class="fa fa-floppy-o" aria-hidden="true"> Modificar</i>
                                                                </button>

                                                                <button id="btn_cancelar_user_<?php echo e($usuario->id_usuario); ?>"
