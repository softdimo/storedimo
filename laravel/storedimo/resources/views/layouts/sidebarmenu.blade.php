    ...
    <nav class="w-100" role="">
        <ul class="nav d-flex flex-column justify-content-center flex-nowrap navbar-nav" id="sidebarnav">
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="personas" role="button" data-bs-toggle="dropdown" aria-expanded="false">Personas</a>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="categorias" role="button" data-bs-toggle="dropdown" aria-expanded="false">Categorías</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="productos" role="button" data-bs-toggle="dropdown" aria-expanded="false">Productos</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="existencias" role="button" data-bs-toggle="dropdown" aria-expanded="false">Gestionar Existencias</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="entradas" role="button" data-bs-toggle="dropdown" aria-expanded="false">Entradas</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="ventas" role="button" data-bs-toggle="dropdown" aria-expanded="false">Ventas</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="prestamos" role="button" data-bs-toggle="dropdown" aria-expanded="false">Préstamos a Empleados</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
            ...
            <li class="pt-1 pb-1 d-flex justify-content-between align-items-center nav-item dropdown" style="border-bottom: 1px solid #e7e7e7">
                ...
                <a href="" class="text-decoration-none dropdown-toggle" style="width: 80%" id="pagos" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pagos a Empleados</a>
                <span class="fa fa-angle-left text-center" aria-hidden="false" style="color: #000; width: 10%"></span>
